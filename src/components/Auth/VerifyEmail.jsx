...
const VerifyEmail = ({ userId, email, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onSuccess(res.data.user); // Contains token usually or separate
        } catch (err) {
    ...
    return (
        <div className="auth-container">
            <h2 className="stats-title" style={{ textAlign: 'center', fontSize: '1.5rem', marginBottom: '1rem' }}>Verify Email</h2>
            <p style={{ textAlign: 'center', color: '#a0a0b8', marginBottom: '1rem' }}>
