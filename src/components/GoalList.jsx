...
const GoalList = ({ habits }) => {
  ...
  return (
    <div style={{ marginTop: "2rem" }}>
      ...
      >
        <h2 className="stats-title" style={{ fontSize: "1.2rem", margin: 0 }}>
          Goals & Milestones
        </h2>
        <button
            ...
            >
              ...
              <div className="goal-progress-section">
                ...
                <div className="goal-progress-track">
                  <div
                    className={`goal-progress-fill ${isCompleted ? "completed" : "in-progress"}`}
                    style={{ width: `${pct}%` }}
                  />
                </div>
              </div>
